...
char switch1_state_changed, switch2_state_changed, switch3_state_changed, switch4_state_changed;
...
switch_interrupt_handler()
{
  ...
  */
  switch2_state_changed = switch2_state_down ? 1 : 0;
  switch3_state_changed = switch3_state_down ? 1 : 0;
  switch4_state_changed = switch4_state_down ? 1 : 0;

  led_update();
  
  buzzer_change_period3();
  
  buzzer_change_period2();

  buzzer_change_period4();
}
